...
def buttons(message):
    ...
    item_tgchannel = types.KeyboardButton(text = 'Новости и подарки')
...
def get_text(message):
  ...
  # если "аргумент" цифра
    ...
    if message.text == 'Новости и подарки':
        url = 'https://t.me/rubmoneychannel'
        client.send_message(message.chat.id, f'Наш Telegram канал с новостями и бонусами для участников: {url}')
